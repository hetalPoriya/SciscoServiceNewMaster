class ServiceDone {
  List<ServiceRequestDone> serviceRequest;
  String status;
  int error;

  ServiceDone({this.serviceRequest, this.status, this.error});

  ServiceDone.fromJson(Map<String, dynamic> json) {
    if (json['service_request'] != null) {
      serviceRequest = <ServiceRequestDone>[];
      json['service_request'].forEach((v) {
        serviceRequest.add(new ServiceRequestDone.fromJson(v));
      });
    }
    status = json['status'];
    error = json['error'];
...
class ServiceRequestDone {
  ...
  ServiceRequestDone.fromJson(Map<String, dynamic> json) {
